...
const Menu = ({ isLoggedIn }) => {
  return (
    <Popover
      className={
        "flex justify-between lg:justify-start lg:grid grid-cols-3 bg-white px-4 sm:px-6 mx-2 mb-4 md:mx-10 2xl:mx-40"
      }
    >
      {/* Desktop */}
      ...
      {/* Desktop Search Bar */}
      <div className="hidden lg:col-span-1 mt-1 ml-10">
        <div className="flex items-start justify-between bg-white px-2 mx-1">
          <div className="relative mb-4 max-w-xl flex-1">
            <input
              type="text"
              id="search"
      ...
      <div className="col-span-1">
        <Popover.Group
          as="nav"
          className="hidden space-x-10 lg:flex justify-end"
        >
              ...
              <>
                ...
                >
                  <div className="flex items-center justify-center">
                    <p className="text-labelme-pink text-opacity-60">
                      Start Creating
                    </p>
                  </div>
                </Popover.Button>
          ...
          <Popover className="relative">
            {({ open }) => (
              <>
                <Popover.Button
                  className={classNames(
                    "group inline-flex items-center border border-1 border-labelme-wine p-2 rounded-full text-base text-gray-900 hover:text-gray-900 focus:outline-none"
                  )}
                >
                  <Image
                    src={Bar}
      ...
      <div>
        <Image priority={true} src={Logo} alt="LabelMe Logo" width="120" />
      </div>
      {/* Menu Icon Mobile */}
