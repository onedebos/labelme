...
const HowItWorks = () => {
  return (
    <div className="flex flex-col justify-between md:space-x-32 md:flex-row mt-24 mx-auto">
      ...
      <div className="md:ml-30 mx-5 md:mx-0">
        <p className="text-labelme-black text-4xl md:text-4xl space-y-10 font-semibold">
          How it Works
          <span className="block text-labelme-black max-w-sm text-lg md:text-xl font-medium">
        ...
        <div className="bg-labelme-pink-lighter rounded-md py-2 px-3 mt-5">
          <p className="text-2xl text-labelme-black">Select Your Shade</p>
        ...
        <div className="bg-labelme-pink-lighter rounded-md py-2 px-3 mt-5">
          <p className="text-2xl text-labelme-black">Confirm and Pay</p>
